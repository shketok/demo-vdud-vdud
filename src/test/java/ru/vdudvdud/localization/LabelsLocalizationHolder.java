...
public enum LabelsLocalizationHolder implements LocalizedValue {
    ...
    private static final AbstractLocalizationProvider labelsLocalizationProvider = new LabelsLocalizationProvider(
        "labels.Labels");

    private final String key;

    LabelsLocalizationHolder(@NonNull String key) {
        this.key = key;
    }
