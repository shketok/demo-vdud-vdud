...
public class RemoveViaInputZeroValueConfirmProductRemovalInTheCart extends BaseTest {
    ...
    private final int ZERO_PRODUCTS_COUNT = 0;
    ...
    @Test
    @Link("https://outsourceofthebrain.myjetbrains.com/youtrack/issue/VDUDUD-27")
    public void runTest() {
        ...
        cartSteps.setProductCount(product, ZERO_PRODUCTS_COUNT);
