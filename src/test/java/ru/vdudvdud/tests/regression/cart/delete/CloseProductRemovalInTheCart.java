...
public class CloseProductRemovalInTheCart extends BaseTest {
    ...
    @Test
    @Link("https://outsourceofthebrain.myjetbrains.com/youtrack/issue/VDUDUD-30")
    public void runTest() {
        ...
        LOG.info("Нажатие кнопки удаления товара из корзины и закрытие попапа удаления из корзины");
        cartSteps.deleteProduct(product);
        cartSteps.closeProductRemoval();
